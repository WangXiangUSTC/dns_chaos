...
func (h Chaos) ServeDNS(ctx context.Context, w dns.ResponseWriter, r *dns.Msg) (int, error) {
	fmt.Printf("ServerDNS, w: %v, r: %v", w, r)
...
func (h Chaos) otherRecordsExist(qname string) bool {
